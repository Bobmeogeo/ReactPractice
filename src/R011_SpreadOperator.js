...
class R011_SpreadOperator extends Component{
    ...
    componentDidMount() {
        ...
        // javascript object
        var sumLetObj = Object.assign({}, varObj1, varObj2);
        console.log('4. sumVarObj:' +JSON.stringify(sumLetObj));
        // ES6 Object
        var sumLetObj = {...varObj1, ...varObj2};
        console.log('5. sumLetObj: ' +JSON.stringify(sumLetObj));
        var {key1, key3, ...others} = sumLetObj;
        console.log('6. key1: ' + key1 + ', key3: ' + key3 + ', ohters: ' + JSON.stringify(others));
    }
